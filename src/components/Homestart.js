function Homestart(){
    return(
        <>
        <div className="container grid grid-cols-2 gap-4 max-h-full pt-32 pb-44">
            <div  class= "Div-1" className="block ml-32">
                <h1 className="text-4xl font-medium text-gray-700  text-left">ENJOY YOUR HEALTHY <br></br>DELICIOUS FOOD</h1>
