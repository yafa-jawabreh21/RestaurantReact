    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 md:py-8">
        <div class="md:block md:justify-between sm:flex">
          <div class="mb-6 md:mb-0">
              ...
              <p className=" text-white float-left sm:w-60 md:w-96 pt-5 text-left">Mealify is a restaurant landing page that offers a delicious dining experience to its customers.</p>
          ...
          <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
              <div>
                  ...
                  <p className="text-white float-left lg:w-96  text-left text-sm">Don't miss out on our latest menu updates and exclusive offers . join our newsletter today and stay up-to-date with all things Mealify!</p>
                  <br></br>
                  <form className="">
              ...
              <h2 class="mb-6 text-sm font-semibold text-white uppercase dark:text-white text-left">Get in Touch </h2>
                  <ul class="text-white font-normal">
                      ...
                      <path fill-rule="evenodd" d="M11.906 1.994a8.002 8.002 0 0 1 8.09 8.421 7.996 7.996 0 0 1-1.297 3.957.996.996 0 0 1-.133.204l-.108.129c-.178.243-.37.477-.573.699l-5.112 6.224a1 1 0 0 1-1.545 0L5.982 15.26l-.002-.002a18.146 18.146 0 0 1-.309-.38l-.133-.163a.999.999 0 0 1-.13-.202 7.995 7.995 0 0 1 6.498-12.518ZM15 9.997a3 3 0 1 1-5.999 0 3 3 0 0 1 5.999 0Z" clip-rule="evenodd"/>
                          ...
                          <h3 className=" text-left" >A108 Adam Street,New York, NY 535022</h3>
                      </li>
                      ...
                      <h3 className=" text-left">contact@example.com</h3>
                      </li>
                      <li className="flex lg:w-96">
                      <svg class="w-8 h-8 pr-2 text-red-700 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
